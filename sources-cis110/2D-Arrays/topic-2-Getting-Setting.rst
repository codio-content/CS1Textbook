...
Getting a Value from a 2D Array
------------------------------
...
- 2D array objects may not be rectangular. These are called ragged arrays.

- Unless otherwise specified, when accessing the element at arr[first][second], the first index is used for rows, the second index is used for columns.
