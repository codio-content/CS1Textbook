...
You will learn to write your own classes later. However, if you see a class definition, like the one below for a class called ``Date``, you should be able to pick out the attributes (instance variables) and the constructors and know how to use them.
